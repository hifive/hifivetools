 ...
 *
 */
 package jp.co.nssol.h5.tool.jslint.util;
...
import jp.co.nssol.h5.tool.jslint.engine.option.JSLintDefaultOptions;
...
public final class ConfigBeanUtil {
	...
	public static String[] checkProperty(ConfigBean changedBean) {
		...
		if (!changedBean.isUseOtherProject()) {
			...
			if (!PluginResourceUtils.isExistFile(changedBean.getOptionFilePath())
					|| !StringUtils.endsWith(changedBean.getOptionFilePath(), JSLintPluginConstant.EXTENTION_OPTION)) {
