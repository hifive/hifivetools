...
public final class JSLintConfigManager {
	 ...
	 * @param config 設定ファイル
	 */
	public static final void putConfig(IProject project, JSLintConfig config) {
	 ...
	 */
	public static final void loadConfig(IProject project) {
	 ...
	 * @param project 対象プロジェクト
	 */
	public static final void saveConfig(IProject project) {
	 ...
	 */
	public static final ConfigBean getDefaultConfigBean(IProject project) {
