...
import jp.co.nssol.h5.tools.codeassist.ui.logger.H5CodeAssistPluginLoggerImpl;
...
public class H5CodeAssistUIPlugin extends AbstractUIPlugin {
	 ...
	 * プラグインID.
	 */
	public static final String PLUGIN_ID = "jp.co.nssol.h5.tools.codeassist.ui.H5CodeAssistUIPlugin"; //$NON-NLS-1$
